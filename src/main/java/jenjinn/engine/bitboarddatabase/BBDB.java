...
public class BBDB
{
	...
	/**
	 * Array of 64 bitboards representing single squares on a chessboard. They are
	...
	/**
	 * Array of 8 bitboards representing the ranks on a chessboard. Ordered rank 1
	 * up to rank 8.
	 */
	public static final long[] RNK;

	/**
	 * Array of 8 bitboards representing the files on a chessboard. Ordered from a
	 * to h.
	 */
